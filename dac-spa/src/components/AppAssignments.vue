					...
					>
						<v-tooltip bottom>
							...
							<v-card flat color="transparent" class="mx-auto">
								<div v-if="app.allUsers" class="white--text caption">
									Always Assigned
								</div>
								<div v-else class="white--text caption">
									Click to {{ app.on ? deactivate : activate }}
								</div>
							</v-card>
						</v-tooltip>
					</v-col>
